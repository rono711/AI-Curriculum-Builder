...
class QuizWriter:
    ...
    def update_quiz(
        ...
        while True:
            ...
            if value == lesson_package_id:
                ...
                if "quiz_filename" in headers:

                    sheet.cell(

                        row=row,

                        column=headers["quiz_filename"]

                    ).value = quiz_filename

                if "gift_filename" in headers:

                    sheet.cell(

                        row=row,

                        column=headers["gift_filename"]
    ...
    def update_descriptions(
            ...
            while True:
                ...
                if value == lesson_package_id:
                    print("MATCH FOUND")
                    if "quiz_title" in headers:
                        sheet.cell(

                            row=row,

                            column=headers["quiz_title"]

                        ).value = quiz_title

                    if "quiz_description" in headers:
                        sheet.cell(

                            row=row,

                            column=headers["quiz_description"]
